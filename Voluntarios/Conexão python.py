...
def cadastrar():
    ...
    try:
        ...
        query = """
            INSERT INTO voluntario (nome, cidade, email, telefone, experiencia, disponibilidade, ajuda, habilidades)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
        """
        cursor.execute(query, (nome, cidade, email, telefone, experiencia, disponibilidade, ajuda, habilidades))
        connection.commit()
